...
This content is a copy of the IHE IT Infrastructure Appendix Z on FHIR published on March 6, 2019.
The normative text can be found at https://www.ihe.net/uploadedFiles/Documents/ITI/IHE_ITI_Suppl_Appx-Z.pdf.
...
FHIR http://hl7.org/fhir/R4/search.html specifies a series of query parameter types which may be
...
other fields where exact matches are required. (See FHIR http://hl7.org/fhir/R4/search.html#token.)
...
FHIR http://hl7.org/fhir/R4/search.html#string.)
...
FHIR http://hl7.org/fhir/R4/CapabilityStatement.html.

Actors providing http server functionality shall publish a `CapabilityStatement` on the
metadata endpoint as described in FHIR http://hl7.org/fhir/R4/http.html#capabilities.
...
described in FHIR http://hl7.org/fhir/R4/structuredefinition.html.
...
References are described in FHIR http://hl7.org/fhir/R4/references.html.
...
This is described in FHIR http://hl7.org/fhir/R4/http.html#mime-type. The server actor
...
FHIR http://hl7.org/fhir/R4/security.html#AccessDenied and http://hl7.org/fhir/R4/operationoutcome.html
...
design and deployment of the operational environment. See FHIR Security and Privacy Module
http://hl7.org/fhir/R4/secpriv-module.html.
...
identifies a thing or object (see FHIR http://hl7.org/fhir/R4/datatypes.html#identifier) including
medical record numbers or patient identifiers. See Appendix Z.9.1 for general guidance on FHIR
