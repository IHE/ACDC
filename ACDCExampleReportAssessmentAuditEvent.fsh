Instance:       ACDCExampleReportAssessmentAuditEvent
InstanceOf:     ACDCReportAssessmentAuditEvent
Title:          "IHE ACDC Example AuditEvent for the [PCC-73] Report Assessment transaction"
Description:    "An example of a populated AuditEvent sent on completion of the IHE PCC-73 transaction."
